...
const PetID_ABI = [
  ...
  "function getPetBasic(uint256 petId) view returns (tuple(string name, string species, string breed, string color, address petOwner, bool exists, uint256 birthDate))",
  "function getPetExtended(uint256 petId) view returns (tuple(string imageURI, address nftContract, uint256 nftTokenId, uint256 registeredAt))",
